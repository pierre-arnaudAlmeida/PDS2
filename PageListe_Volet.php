...
<head>
	...
	<title>Liste Volets</title> <!-- titre dans l'onglet -->
</head>
<body>
	...
	<div id="pageListe">
		...
		<div id="Liste">
			...
			?>
			<div id="Ligne">
				<image src="https://www.rodriguez-64.fr/wp-content/uploads/sites/626/2016/04/icon-volet-battant.png" width="60" height="70"></image>	
				<div class="cadre">
