...
s
	<title>Connexion à Device Manager</title> <!-- titre dans l'onglet -->
</head>
<body>
	<?php include("include/Header.php"); ?>
		<div id="pageconnexion">
			...
			<div id="Nav">
				...
				<h1> Dans le cas ou vous avez oublier votre mot de passe nous vous invitons à <a href="PageConnexion.php"> Cliquer ici</a></h1>
			</div>
		</div>
</body>
