<div id="Inscription">
  <div id="colonne">
      ...
      <div id="Cadre-Nom">
        <div class="nom">                    
          <h>Nom <input type="text" name="nom_inscription" required/></h>                                          
        </div>
      </div>
      <div id="Cadre-prenom">
        <div class="prenom">                    
          <h>Prénom <input type="text" name="prenom_inscription" required/></h>                                          
        </div>
      </div>
      <div id="Cadre-email">
        <div class="email">                    
          <h>Email <input type="email" name="email" required/></h>                                          
        </div>
      </div>
      <div id="Cadre-date_naissance">
        <div class="date_naissance">                    
          <h>Date de naissance <input type="date" name="date_naissance" required/></h>                                          
        </div>
      </div>
